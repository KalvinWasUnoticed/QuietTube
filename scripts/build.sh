...
xcrun --sdk iphoneos clang -arch arm64 -isysroot "$sdk" \
  ...
  Sources/QTCore.m Sources/QTSettings.m Sources/QTSettingsModel.m Sources/QTFeatures.m Sources/QTLogo.m Sources/QTAdProfile.m Sources/QTMutationTrace.m Sources/QTFeedInsertion.m \
