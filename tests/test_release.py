...
class ReleaseTests(unittest.TestCase):
    def invoke(self, private='true', approval='false', gh_fail=False, create_ipa=True):
        with tempfile.TemporaryDirectory() as t:
            ...
            if create_ipa: (root/'artifacts/QuietTube-0.9-21.38.2.ipa').write_bytes(b'fixture')
            gh=root/'bin/gh'
    ...
    def test_private_direct_link_and_actual_ipa_argument(self):
        ...
        self.assertIn('releases/download/quiettube-0.9-123-2/QuietTube-0.9-21.38.2.ipa',summary)
        self.assertIn('artifacts/QuietTube-0.9-21.38.2.ipa',call)
